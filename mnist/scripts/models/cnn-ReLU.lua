...
fullLinear1 = nn.Linear(nPlanes[4]*7*7, nHL1)
model:add(fullLinear1) -- Connection weights
model:add(nn.ReLU()) -- Hyperbolic tangent non-linear function

fullLinear2 = nn.Linear(nHL1, nHL2)
model:add(fullLinear2) -- Connection weights
model:add(nn.ReLU()) -- Hyperbolic tangent non-linear function
